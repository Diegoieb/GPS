...
const getSaleProduct = (req, res)=>{
    saleProduct.find().populate('product','name','sale','total').exec((err,saleProductS)=>{
        if(err){
...
//populate(), filter() funcion buscar por id de venta y mostrar los productos de dicha venta
